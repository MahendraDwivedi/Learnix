    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0'>
      <form onSubmit={handleSubmit} action="">
        ...
        <div className='flex items-center justify-between flex-wrap'>
          <div className='flex flex-col gap-1'>
            <p>Course Price</p>
            <input type="text" onChange={e => setCoursePrice(e.target.value)} value={coursePrice} placeholder='0' className='outline-none md:py-2.5 py-2 w-28 px-3 rounded border border-gray-500' required />
          </div>
        ...
        <div>
          {chapters.map((chapter,chapterIndex) => (
            <div key={chapterIndex} className='bg-white border rounded-lg mb-4 mt-3'>
          ...
          <div className='flex justify-center items-center bg-blue-100 p-2 rounded-lg cursor-pointer mt-3' onClick={() => handleChapter('add')}>+ Add Chapters</div>
            ...
            showPopup && (
              <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
                <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                  ...
                  <div className='mb-2'>
                    <p>Lecture URL</p>
                    <input type="text" className='mt-1 block w-full border rounded py-1 px-2' value={lectureDetails.lect}
                  ...
                  <button type='button' className='w-full bg-blue-400 text-white px-2 py-2 rounded' onClick={addLecture}>Add</button>
