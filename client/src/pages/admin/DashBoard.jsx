      ...
      <tbody>
        {filteredUsers.map((u, i) => (
          <tr key={i} className="border-b hover:bg-gray-100 dark:hover:bg-gray-600">
            <td className="p-2 break-words max-w-xs">{u.name || "-"}</td>
            <td className="p-2 break-words max-w-xs">{u.email}</td>
          ...
          filteredCourses.map(course => (
            ...
            >
              ...
              <div className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
                ...
                <div>Created on: <strong>{new Date(course.createdAt).toDateString()  }</strong></div>
                <div>Updated on: <strong>{new Date(course.updatedAt).toDateString()  }</strong></div>
