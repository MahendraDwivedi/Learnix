  ...
  return (
    <div className='py-16 md:px-40 px-8'>
        ...
        <p className="text-sm md:text-base text-gray-600 mt-3">
           Explore expertly curated courses across diverse fields — from coding and design to
           <br className="hidden sm:block" />
           business, wellness, and beyond. Every course is built to empower and inspire growth.
        </p>            
